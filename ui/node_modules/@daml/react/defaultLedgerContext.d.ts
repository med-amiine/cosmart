...
import { FetchResult, QueryResult, LedgerProps, FetchByKeysResult } from "./createLedgerContext";
 ...
 */
export declare function DamlLedger(props: React.PropsWithChildren<LedgerProps>): React.ReactElement | null;
/**
 ...
 */
export declare function useFetch<T extends object, K, I extends string>(template: Template<T, K, I>, contractId: ContractId<T>): FetchResult<T, K, I>;
/**
 ...
 */
export declare function useStreamQuery<T extends object, K, I extends string>(template: Template<T, K, I>, queryFactory?: () => Query<T>, queryDeps?: readonly unknown[], closeHandler?: (e: StreamCloseEvent) => void): QueryResult<T, K, I>;
/**
 * React Hook to query the ledger, the returned result is updated as the ledger state changes.
 *
 * @typeparam T The contract template type of the query.
 ...
 * @return The matching contracts.
 */
export declare function useStreamQueries<T extends object, K, I extends string>(template: Template<T, K, I>, queryFactory?: () => Query<T>[], queryDeps?: readonly unknown[], closeHandler?: (e: StreamCloseEvent) => void): QueryResult<T, K, I>;
/**
 ...
 *         the same position.
 */
export declare function useStreamFetchByKeys<T extends object, K, I extends string>(template: Template<T, K, I>, keyFactory: () => K[], keyDeps: readonly unknown[]): FetchByKeysResult<T, K, I>;
/**
